        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PlaceSpace = table.Column<string>(type: "text", nullable: false),
                    PlaceAmenities = table.Column<List<string>>(type: "text[]", nullable: false),
                    ...
                    WishlistDtoId = table.Column<Guid>(type: "uuid", nullable: true)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Homes_Wishlists_WishlistDtoId",
                        column: x => x.WishlistDtoId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TripInfo = table.Column<string>(type: "text", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Homes_WishlistDtoId",
                table: "Homes",
                column: "WishlistDtoId");
